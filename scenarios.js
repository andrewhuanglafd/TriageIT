...
(function () {
  ...
  function generateDeck(count, difficulty) {
    ...
    const weights = difficulty === 'veteran' ? VETERAN_WEIGHTS : NORMAL_WEIGHTS;
    const queue = buildCategoryQueue(count, weights);
  ...
  const TRIAGE_INFO = {
    red:    { label: 'RED',    short: 'RED',    color: '#ef3b3b', ink: '#ffffff' },
    yellow: { label: 'YELLOW', short: 'YELLOW', color: '#f5b800', ink: '#2a1f00' },
    green:  { label: 'GREEN',  short: 'GREEN',  color: '#22c55e', ink: '#02240f' },
    black:  { label: 'BLACK',  short: 'BLACK',  color: '#0a0a0c', ink: '#ffffff' },
  };
