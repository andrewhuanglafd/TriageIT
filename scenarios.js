...
(function () {
  ...
  const FATAL_INCIDENTS = [
    { head: 'TAGGED THE WALKING GUY',
      body: 'You called a walking-wounded patient deceased. He walked off, filed a complaint with the BC, and made captain before you did.' },
    { head: 'MISSED THE TACHYPNEA',
      body: 'RR was 32. You tagged DELAYED. Patient coded en route. The truck guys are calling you a delay specialist.' },
    { head: 'WRONG PRIORITY',
      body: 'You spent 90 seconds on a stable patient while the bleeder three feet away introduced themselves to the floor.' },
    { head: 'BLACK MEANS BLACK',
      body: 'Apneic after the maneuver means BLACK. You worked him anyway. The next RED expired waiting for you to figure it out.' },
    { head: 'OVER-TRIAGED',
      body: 'Called every yellow a red. Resources ran out. The actual reds are still waiting. So is the captain.' },
    { head: 'UNDER-TRIAGED',
      body: 'Called the reds yellows. They went to the bottom of the transport list. Your career joined them.' },
    { head: 'SKIPPED THE PERFUSION CHECK',
      body: 'Cap refill was 4 seconds. Patient was 7. Numbers are math, not vibes. The math noticed.' },
    { head: 'ALTERED, NOT ASLEEP',
      body: 'Patient couldn\'t follow "show me two fingers." You called it minor. The CT scan disagreed. Loudly.' },
    { head: 'WALKING IS GREEN',
      body: 'Ambulatory always wins. You over-tagged the walking guy. Two reds did self-triage while you deliberated.' },
    { head: 'ONE WRONG CALL',
      body: 'Expert mode: one bad call ends it. You found the bad call. With enthusiasm.' },
    { head: 'AGONAL ISN\'T BREATHING',
      body: 'Called the agonal gasp "breathing." Patient disagreed. The monitor disagreed. Even the probie disagreed.' },
    { head: 'NO PULSE, NO PROBLEM?',
      body: 'Said "looks pretty good" on a patient with no radial pulse. The pulse begs to differ. So does the patient.' },
    { head: 'STAGGER ≠ WALK',
      body: 'Confused "staggering" with "walking." Captain wants you to take the field-sobriety class before the triage class.' },
    { head: 'SCANNED THE WRONG VITAL',
      body: 'Spent the whole assessment reading the narrative. The vitals were right there. Numbers go brrrr.' },
    { head: 'TAGGED THE FURNITURE',
      body: 'You tagged a mannequin RED. The instructor put it on the wall. Bring snacks to the debrief.' },
  ];
